; ModuleID = '/media/roza/Backup2/NIRCompilers/llvm-project/llvm/lib/Transforms/AddVars/tests_addvar/TwoArrays.ll'
source_filename = "/media/roza/Backup2/NIRCompilers/llvm-project/llvm/lib/Transforms/AddVars/tests_addvar/TwoArrays.c"
...
entry:
  ...
  %prob6 = add i64 0, 1
  %9 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @d, i64 0, i64 9), align 4, !tbaa !2
  %prob7 = add i64 0, 1
  %10 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @d, i64 0, i64 5), align 4, !tbaa !2
  %add5 = add nsw i32 %9, %10
  %prob8 = add i64 0, 1
  %11 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @d, i64 0, i64 4), align 16, !tbaa !2
  %add6 = add nsw i32 %add5, %11
  %prob9 = add i64 0, 0
  %12 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @d, i64 0, i64 7), align 4, !tbaa !2
  %add7 = add nsw i32 %add6, %12
  %prob10 = add i64 0, 0
  %13 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @d, i64 0, i64 8), align 16, !tbaa !2
  %add8 = add nsw i32 %add7, %13
  %prob11 = add i64 0, 1
  %14 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @e, i64 0, i64 3), align 4, !tbaa !2
  %add9 = add nsw i32 %add8, %14
  store i32 %add9, i32* %b, align 4, !tbaa !2
  %prob12 = add i64 0, 0
  %15 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @e, i64 0, i64 6), align 8, !tbaa !2
  %prob13 = add i64 0, 0
  %16 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @e, i64 0, i64 10), align 8, !tbaa !2
  %add10 = add nsw i32 %15, %16
  %prob14 = add i64 0, 0
  %17 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @e, i64 0, i64 11), align 4, !tbaa !2
  %add11 = add nsw i32 %add10, %17
  %prob15 = add i64 0, 1
  %18 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @d, i64 0, i64 8), align 16, !tbaa !2
  %add12 = add nsw i32 %add11, %18
  %prob16 = add i64 0, 0
  %19 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @d, i64 0, i64 9), align 4, !tbaa !2
  %add13 = add nsw i32 %add12, %19
  %prob17 = add i64 0, 0
  %20 = load i32, i32* getelementptr inbounds ([15 x i32], [15 x i32]* @d, i64 0, i64 13), align 4, !tbaa !2
